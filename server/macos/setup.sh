#!/bin/bash
# setup.sh - Complete server setup for macOS

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo "Setting up pocket-tether server on macOS..."
echo ""
...
echo "2. Add client WireGuard peers to /usr/local/etc/wireguard/wg0.conf"
